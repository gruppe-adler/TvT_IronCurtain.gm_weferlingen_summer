class CfgNVAFortifications {
    ...
    class Fortifications {
        ...
        class ACE_FlareTripMine {
            demolitionTime = 3;
            icon = "grad-nvacommand\vehicles\build_tripflare2.paa";
            amount = 40;
        ...
        class land_gm_tanktrap_02 {
            demolitionTime = 30;
            icon = "grad-nvacommand\vehicles\build_hedgehog2.paa";
            amount = 20;
        ...
        class Sign_Circle_F {
            demolitionTime = 20;
            icon = "grad-nvacommand\vehicles\build_gmn.paa";
            amount = 20;
        ...
        class Sign_Circle_F {
            demolitionTime = 60;
            icon = "grad-nvacommand\vehicles\build_hundelaufanlage.paa";
            amount = 20;
