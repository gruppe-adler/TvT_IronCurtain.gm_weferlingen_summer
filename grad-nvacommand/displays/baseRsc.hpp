...
class grad_nvaCommand_RscBackground {
    idc = -1;
    type = CT_STATIC;
...
class grad_nvaCommand_RscStructuredText {
    idc = -1;
    access = 0;
...
class grad_nvaCommand_RscPicture {
    shadow = 0;
    type = CT_STATIC;
    style = 48 + 2048;
    sizeEx = 0.023;
...
class grad_nvaCommand_RscPictureKeepAspect: grad_nvaCommand_RscPicture {
    style = "0x30 + 0x800";
};


class grad_nvaCommand_RscButton {
    x = 0;
    y = 0;
    w = 0.15;
    h = 0.1;
...
class grad_nvaCommand_RscButtonSilent {
    x = 0;
    y = 0;
    w = 0.15;
    h = 0.1;
