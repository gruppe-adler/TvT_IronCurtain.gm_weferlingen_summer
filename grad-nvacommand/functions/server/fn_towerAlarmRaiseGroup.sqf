...
for "_i" from 1 to (_towerCrewCount) do {
	private _unit = _group createUnit ["gm_gc_bgs_rifleman_mpikm72_80_str", _positionBehindDoor, [], 0, "NONE"];
    ...
    _tower setVariable ["GRAD_nvaCommand_towerUnits", units _group, true];
