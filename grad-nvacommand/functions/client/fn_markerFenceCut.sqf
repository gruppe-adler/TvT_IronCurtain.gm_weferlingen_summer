...
private _centerMarker = createMarker [format ["GRAD_nvaCommand_fenceCutMarker_center_%1",CBA_missionTime * 1000],_position];
...
private _areaMarker = createMarker [format ["GRAD_nvaCommand_fenceCutMarker_area_%1",CBA_missionTime * 1000],_position];
